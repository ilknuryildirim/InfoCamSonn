 ...
 */
package com.infocam.plugin.arenasplashscreen.service;
import com.infocam.lib.service.IBootStrap;
...
public class ArenaSplashService extends Service{
	...
	private final String ACTIVITY_PACKAGE = "com.infocam.plugin.arenasplash";
	private final String ACTIVITY_NAME = "com.infocam.plugin.arenasplash.ArenaSplashActivity";
