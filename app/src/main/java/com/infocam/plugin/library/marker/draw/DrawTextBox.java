 ...
 */
package com.infocam.plugin.library.marker.draw;
...
public class DrawTextBox extends DrawCommand {
	...
	public DrawTextBox(Boolean visible, Double distance, String title, Boolean underline, TextObj textblock, Label textlab, MixVector signMarker){
		...
		setProperty(PROPERTY_NAME_TEXTBLOCK, new ParcelableProperty("com.infocam.lib.gui.TextObj", textblock));
		setProperty(PROPERTY_NAME_TEXTLAB, new ParcelableProperty("com.infocam.lib.gui.Label", textlab ));
		setProperty(PROPERTY_NAME_SIGNMARKER, new ParcelableProperty("com.infocam.lib.render.MixVector", signMarker));
	}
