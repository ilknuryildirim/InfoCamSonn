...
import com.infocam.plugin.PluginLoader;
import com.infocam.plugin.PluginType;
...
/**
 * This is the plugin loading activity for infocam. This activity will load a splashscreen and then initializes the PluginLoader
 * It will then launch the visible bootstrap plugins and waits for their results. After all bootstrap plugins are loaded
 * then infocam will be launched.
 * @author A.Egal
 */
