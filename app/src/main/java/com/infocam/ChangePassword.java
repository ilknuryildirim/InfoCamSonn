    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        changepass.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(changepass.getText().length()!=0)
                    NetAsync(view);
            }
        });}
            ...
            try {
                if (json.getString(KEY_SUCCESS) != null) {
                    ...
                    if (Integer.parseInt(res) == 1) {
                        ...
                        Toast.makeText(ChangePassword.this, "Your Password is successfully changed.", Toast.LENGTH_SHORT).show();

                        Intent login = new Intent(getApplicationContext(), SettingActivity.class);
                        startActivity(login);
                        finish();
