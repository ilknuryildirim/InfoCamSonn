...
public class GalleryActivity extends BaseActivity {
    ...
    private class DownloadImage extends AsyncTask<String,String, JSONObject>{
        ...
        protected JSONObject doInBackground(String... args) {
            ...
            JSONObject json = userFunction.getAllPics();
        ...
        protected void onPostExecute(JSONObject json) {
            try {
                if (json.getString(KEY_SUCCESS) != null) {
                    ...
                    Log.d("GALLERYASD", json.toString());
                    ...
                    g = new GridAdapter(GalleryActivity.this, data);
                    imagesList.setAdapter(g);
                    detector = new GestureDetector(GalleryActivity.this, new SwipeGestureDetector());
                    pDialog.dismiss();
